...
//        public ActionResult Create([Bind(Include = "Id,Email,Password,ConfirmPassword,IsAdmin,UserName")] User user)
//        {
...
//        [HttpPost]
//        //[ValidateAntiForgeryToken]
//        public ActionResult Edit([Bind(Include = "Id,Email,Password,ConfirmPassword,IsAdmin,UserName")] User user)
//        {
//            if (ModelState.IsValid)
//            {
